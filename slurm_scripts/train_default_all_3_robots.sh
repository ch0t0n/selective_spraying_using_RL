...
conda run --no-capture-output -n rl4pag python3 train_default.py --algorithm $algorithm --set $set --verbose 1 --log_steps 10000 --seed 33 --steps $steps --num_robots $num_robots
