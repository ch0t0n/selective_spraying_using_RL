...
#SBATCH --output=/homes/choton/rl4pag/selective_spraying_using_RL/slurm_logs/step1_default/outputs/%x_%j.out
#SBATCH --error=/homes/choton/rl4pag/selective_spraying_using_RL/slurm_logs/step1_default/errors/%x_%j.out
#SBATCH --nodes=1
