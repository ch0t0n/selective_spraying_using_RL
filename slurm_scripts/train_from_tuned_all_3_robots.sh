...
# EDITED:
# Run all experiments with: sbatch slurm_scripts/train_from_tuned_all_3_robots.sh

#SBATCH --array=0-49
#SBATCH --job-name=RL4PA_ft3r_James
...
# EDITED:
RUN_NAME="${algorithm}_set${set}_seed${seed}_from_tuned_3_robots_cpu"
