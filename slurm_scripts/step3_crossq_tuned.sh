...
#SBATCH --output=/homes/choton/rl4pag/selective_spraying_using_RL/slurm_logs/step3_tuned/outputs/%x_%j.out
#SBATCH --error=/homes/choton/rl4pag/selective_spraying_using_RL/slurm_logs/step3_tuned/errors/%x_%j.out
#SBATCH --nodes=1
