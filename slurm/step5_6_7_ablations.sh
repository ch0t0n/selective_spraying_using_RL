#!/bin/bash
# ============================================================
# step5_6_7_ablations.sh — Merged training ablation script
#
# Covers Steps 5, 6, and 7 in a single file.
# Pass the experiment name as the first argument, e.g.:
#
#   sbatch --array=0-199 step5_6_7_ablations.sh ablation_reward
#   sbatch --array=0-199 step5_6_7_ablations.sh ablation_obs
#   sbatch --array=0-199 step5_6_7_ablations.sh ablation_uncertainty
#
...
#SBATCH --array=0-199
#SBATCH --job-name=s5_6_7_ablations
#SBATCH --output=logs/slurm_outputs/s5_6_7_ablations/%x_%A_%a.out
#SBATCH --error=logs/slurm_errors/s5_6_7_ablations/%x_%A_%a.err
#SBATCH --nodes=1
...
# ============================================================
# ── Step 5: Reward function components ───────────────────────
#
...
if [ "$EXPERIMENT" == "ablation_reward" ]; then
    ...
    echo "S5-ablation-reward | condition=$condition | set=$set | seed=$seed | job=$SLURM_ARRAY_TASK_ID"
...
# ============================================================
    ...
    echo "S6-ablation-obs | obs_mode=$obs_mode | set=$set | seed=$seed | job=$SLURM_ARRAY_TASK_ID"
...
# ============================================================
# ── Step 7: Physical uncertainty model ───────────────────────
#
...
# ============================================================
    ...
    echo "S7-ablation-uncertainty | mode=$uncertainty_mode | set=$set | seed=$seed | job=$SLURM_ARRAY_TASK_ID"
