#!/bin/bash
# ============================================================
# Step 3 — Hyperparameter tuning (Optuna, fully parallelised)
#
...
#SBATCH --array=0-299
#SBATCH --job-name=s3_tune
#SBATCH --output=logs/slurm_outputs/s3_tune/%x_%A_%a.out
#SBATCH --error=logs/slurm_errors/s3_tune/%x_%A_%a.err
#SBATCH --nodes=1
...
echo "S3-tune | alg=${algorithm} | trial=${trial_idx} | device=${device} | job=${SLURM_ARRAY_TASK_ID}"
